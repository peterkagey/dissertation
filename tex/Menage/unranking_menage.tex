...
% TODO:
%   - Introduction
%   - If we do a cyclic rotation of the rows of a chessboard, we get essentially the same thing.
%   - Move code to Appendix.
%   - Do we want to talk about parking functions?
%   - Is it worthwhile to discuss prefix functions for compositions, etc.?
%   - Gives a way of sampling uniformly at random.
% \end{enumerate}
