...
\end{corollary}
\begin{proof}
  % TODO: We need to restrict to permutation matrices!
...
\begin{proof}
  ...
  % TODO: should this be two lemmas?
...
% TODO ?
% \subsection{Bar Yehuda's ``open game''}
% Bar Yehuda has an ``open game'' version of the puzzle that goes like this:
...
%     \item Player B says to turn on those two diagonal switches.
