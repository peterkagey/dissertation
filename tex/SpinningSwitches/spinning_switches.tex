...
\begin{proof}
  ...
  Since $k$ is arbitrary the projection map must surject onto $K$ for every
  adversarial sequence to ensure that it contains $k^{-1}$.
...
spinning groups that act faithfully and behave like $p$-groups.
