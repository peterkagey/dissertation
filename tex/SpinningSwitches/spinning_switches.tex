...
We will generalize this construction in
...
The reason that it is appropriate to use a group to model a switch
...
Now that we have proven that large families of wreath products do not have
...
% *-------------------------------*
% Because it is the direct product, there's a farthest right and farthest left
% that are on.
